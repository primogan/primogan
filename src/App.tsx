...
פרטים נוספים: ${formData.message}`;
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-gray-50 to-white text-right ${isHighContrast ? 'high-contrast' : ''} ${isDark ? 'dark' : ''}`} dir="rtl">
      <header role="banner">
      ...
      <main role="main">
        ...
        {/* Hero Section */}
        <section id="hero" className="relative h-screen" aria-label="ראשי">
        ...
        {/* Services Section */}
        <section id="services" className="py-24 px-4 bg-white" aria-label="שירותים">
        ...
        {/* Products Section */}
        <section id="products" className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-7xl mx-auto">
        ...
        <section id="contact" className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white" aria-label="צור קשר">
      ...
      <footer className="bg-gray-900 text-white py-8 px-4" role="contentinfo">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">פרימו-גן</h3>
              <p>תכנון וביצוע גינות מקצועי</p>
              <p>טלפון: 054-200-1104</p>
              <p>אימייל: primo.gan.ltd@gmail.com</p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-4">שירותים</h3>
              <ul className="space-y-2">
                <li>תכנון גינות</li>
                <li>גיזום וכריתת עצים</li>
                <li>תחזוקת גינות</li>
                <li>מערכות השקיה</li>
              </ul>
            </div>
            <div>
              ...
              <p>שישי: 08:00-14:00</p>
              <p>שבת: סגור</p>
            </div>
          </div>
          <div className="mt-8 text-center border-t border-gray-800 pt-8">
            <p>© {new Date().getFullYear()} פרימו-גן. כל הזכויות שמורות.</p>
          </div>
        </div>
      </footer>
    </div>
